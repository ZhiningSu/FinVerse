...
price_target = torch.randn(B, 30, 80 * 5)
...
print(f"vq_loss: {output['vq_loss'].item():.4f}")
print(f"temporal_token_ids shape: {output['temporal_token_ids'].shape}")
print(f"cross_token_ids shape: {output['cross_token_ids'].shape}")
